...
def get_config(nb_name):
    ...
    parser.add_argument('-gauss', type=float, default=1.)
    parser.add_argument('-maxv', '--max_logvar', type=float, default=1.)
    parser.add_argument('-minv', '--min_logvar', type=float, default=-np.inf)
