...
flags.DEFINE_integer('max_doc_l_train', 20, 'maximum length of document for training')
flags.DEFINE_integer('max_sent_l_train', 50, 'maximum length of sentence for training')

flags.DEFINE_integer('min_doc_l_test', 10, 'minimum length of document for evaluation')
flags.DEFINE_integer('max_doc_l_test', 20, 'maximum length of document for evaluation')
